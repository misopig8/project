...
st.title("대구 내 정거장 정보")

plt.rc("font", family = "Malgun Gothic")
sns.set(font="Malgun Gothic", rc={"axes.unicode_minus":False}, style='white')
bus_stops_data = pd.read_csv('c:\\Users\\user\\Downloads\\대구광역시_시내버스 정류소 위치정보_20240924.csv', encoding="utf-8")
top_bus_stops_data = pd.read_csv("C:\\Users\\user\\Downloads\\한국교통안전공단_대구광역시 최다 이용 정류장_20231231.csv", encoding="utf-8")
...
m = folium.Map(location=[35.8714354, 128.601445], zoom_start=12)
